...
void TranslateGizmo::move( float xpos,
                           float ypos,
                           Model& model,
...
glm::vec3 TranslateGizmo::getDir( const glm::mat4& rotation ) {
    ...
    case XSELEC:
        return glm::normalize(
            glm::vec3( rotation * glm::vec4( glm::vec3( 1.f, 0.f, 0.f ), 0.0 ) ) );
    case YSELEC:
        return glm::normalize(
            glm::vec3( rotation * glm::vec4( glm::vec3( 0.f, 1.f, 0.f ), 0.0 ) ) );
    case ZSELEC:
        return glm::normalize(
            glm::vec3( rotation * glm::vec4( glm::vec3( 0.f, 0.f, 1.f ), 0.0 ) ) );
    default:
