...
void Shader::addLight( Light* light ) {
    ...
    case POINT_LIGHT:
    {
        ...
        setVec3( lightType + "[" + std::to_string( m_num_point_light ) + "].position",
                 params.pointlight.position );
        setFloat( lightType + "[" + std::to_string( m_num_point_light ) + "].intensity",
    ...
    case DIR_LIGHT:
    {
        ...
        setVec3( lightType + "[" + std::to_string( m_num_dir_light ) + "].direction",
                 light->model().rotation() * glm::vec4( params.dirlight.direction, 0.f ) );
    ...
    case SPOT_LIGHT:
    {
        ...
        setVec3( lightType + "[" + std::to_string( m_num_spot_light ) + "].position",
                 params.spotlight.position );
        setVec3( lightType + "[" + std::to_string( m_num_spot_light ) + "].direction",
                 params.spotlight.direction );
        setFloat( lightType + "[" + std::to_string( m_num_spot_light ) + "].innerCutoff",
                  glm::cos( glm::radians( params.spotlight.innerCutoff ) ) );
        setFloat( lightType + "[" + std::to_string( m_num_spot_light ) + "].outerCutoff",
                  glm::cos( glm::radians( params.spotlight.outerCutoff ) ) );
        setFloat( lightType + "[" + std::to_string( m_num_spot_light ) + "].intensity",
                  params.spotlight.intensity );
